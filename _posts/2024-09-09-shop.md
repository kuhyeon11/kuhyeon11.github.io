...
Content of chunk only can fill by edit function. <br />
<br />
...
Maybe we can use this by double-free. <br />
<br />

## Analyze & Exploit
<br />
There's no function for printing data. Only creating and editing is possible. <br />
For doing something, we have to leak libc, and it is possible by other ways. <br />
<br />

### make libc_address to some chunks.
...
- By allocate smaller than usnrotedbin, sliced chunk also has main_arena's addr.
<br />
...
- After successfully get libc's addr, we can thought about overwrite malloc_hook or free_hook.
